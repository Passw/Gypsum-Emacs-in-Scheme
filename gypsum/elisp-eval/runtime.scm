...
(define-module (gypsum elisp-eval runtime)
  #:export (nil-value
            t-value
            value-slot-module
...
(define value-slot-module '(gypsum elisp-eval runtime value-slot))

(define function-slot-module '(gypsum elisp-eval runtime function-slot))
