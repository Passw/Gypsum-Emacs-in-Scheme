...
;;
;; (define-module (gypsum elisp-eval parser)
;;   #:use-module (gypsum elisp-eval lexer)
;;   #:export (read-elisp))
;;--------------------------------------------------------------------
...
(define (fluid-ref param) (param))

(define hashq-ref hash-table-ref)
(define hashq-set! hash-table-set!)
