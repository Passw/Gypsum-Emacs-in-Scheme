...
(define-module (gypsum elisp-eval spec)
  #:use-module (gypsum elisp-eval compile-tree-il)
  #:use-module (gypsum elisp-eval parser)
...
(with-native-target
  (lambda ()
    (compile-and-load (%search-load-path "gypsum/elisp-eval/boot.el")
                      #:from 'elisp)))
