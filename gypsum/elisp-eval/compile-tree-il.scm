...
(define-module (gypsum elisp-eval compile-tree-il)
  #:use-module (gypsum elisp-eval bindings)
  #:use-module (gypsum elisp-eval runtime)
...
(define (nil-value loc)
  (make-const loc (@ (gypsum elisp-eval runtime) nil-value)))

(define (t-value loc)
  (make-const loc (@ (gypsum elisp-eval runtime) t-value)))

;;; Modules that contain the value and function slot bindings.

(define runtime '(gypsum elisp-eval runtime))

(define value-slot (@ (gypsum elisp-eval runtime) value-slot-module))

(define function-slot (@ (gypsum elisp-eval runtime) function-slot-module))
